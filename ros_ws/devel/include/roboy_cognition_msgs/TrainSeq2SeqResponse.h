...
bool operator==(const ::roboy_cognition_msgs::TrainSeq2SeqResponse_<ContainerAllocator1> & lhs, const ::roboy_cognition_msgs::TrainSeq2SeqResponse_<ContainerAllocator2> & rhs)
{
