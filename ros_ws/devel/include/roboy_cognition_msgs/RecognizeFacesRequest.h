...
struct RecognizeFacesRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::roboy_cognition_msgs::FacialFeatures_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::roboy_cognition_msgs::FacialFeatures_<ContainerAllocator> >> _encodings_type;
