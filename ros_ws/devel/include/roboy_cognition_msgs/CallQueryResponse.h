...
bool operator==(const ::roboy_cognition_msgs::CallQueryResponse_<ContainerAllocator1> & lhs, const ::roboy_cognition_msgs::CallQueryResponse_<ContainerAllocator2> & rhs)
{
