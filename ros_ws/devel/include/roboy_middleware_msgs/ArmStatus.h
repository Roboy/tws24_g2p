...
struct ArmStatus_
{
  ...
  _id_type id;
   ...
   typedef std::vector<uint16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint16_t>> _current_type;
  _current_type current;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _gyro_x_type;
  _gyro_x_type gyro_x;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _gyro_y_type;
  _gyro_y_type gyro_y;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _gyro_z_type;
  _gyro_z_type gyro_z;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _acc_x_type;
  _acc_x_type acc_x;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _acc_y_type;
  _acc_y_type acc_y;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _acc_z_type;
  _acc_z_type acc_z;
