...
struct DarkRoomStatistics_
{
  ...
  _lighthouse_type lighthouse;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _update_frequency_horizontal_type;
  _update_frequency_horizontal_type update_frequency_horizontal;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _update_frequency_vertical_type;
