...
struct ControllerParameters_
{
  ...
  _k_h_type k_h;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _k_p_theta_left_type;
  _k_p_theta_left_type k_p_theta_left;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _k_p_theta_right_type;
  _k_p_theta_right_type k_p_theta_right;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _k_d_theta_left_type;
  _k_d_theta_left_type k_d_theta_left;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _k_d_theta_right_type;
  _k_d_theta_right_type k_d_theta_right;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _k_p_phi_type;
  _k_p_phi_type k_p_phi;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _k_d_phi_type;
  ...
  _c_swing_prep_type c_swing_prep;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _theta_groin_0_type;
  _theta_groin_0_type theta_groin_0;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _phi_groin_0_type;
  ...
  _phi_trunk_0_type phi_trunk_0;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _theta_knee_type;
  _theta_knee_type theta_knee;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _theta_ankle_type;
  _theta_ankle_type theta_ankle;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _d_s_type;
  _d_s_type d_s;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _d_c_type;
  _d_c_type d_c;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _v_s_type;
  _v_s_type v_s;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _v_c_type;
  _v_c_type v_c;
