...
struct Tendon_
{
  ...
  _force_type force;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _l_type;
  _l_type l;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _ld_type;
  _ld_type ld;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _number_of_viapoints_type;
  _number_of_viapoints_type number_of_viapoints;

   typedef std::vector< ::geometry_msgs::Vector3_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Vector3_<ContainerAllocator> >> _viapoints_type;
...
struct MD5Sum< ::roboy_simulation_msgs::Tendon_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x40cb16776c2b7ebaULL;
  static const uint64_t static_value2 = 0xdec4e4fb33291d31ULL;
};
