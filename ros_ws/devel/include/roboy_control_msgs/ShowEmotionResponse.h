...
bool operator==(const ::roboy_control_msgs::ShowEmotionResponse_<ContainerAllocator1> & lhs, const ::roboy_control_msgs::ShowEmotionResponse_<ContainerAllocator2> & rhs)
{
