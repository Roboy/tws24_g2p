...
bool operator==(const ::roboy_control_msgs::WarningNotification_<ContainerAllocator1> & lhs, const ::roboy_control_msgs::WarningNotification_<ContainerAllocator2> & rhs)
{
