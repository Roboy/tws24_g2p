...
bool operator==(const ::roboy_control_msgs::DangerNotification_<ContainerAllocator1> & lhs, const ::roboy_control_msgs::DangerNotification_<ContainerAllocator2> & rhs)
{
