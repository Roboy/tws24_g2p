...
let LookAtFeedback = require('./LookAtFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class LookAtActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LookAtFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LookAtFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LookAtActionFeedback(null);
    ...
    data.feedback = LookAtFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LookAtActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LookAtFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LookAtFeedback()
    }
...
module.exports = LookAtActionFeedback;
