...
(cl:defmethod header-val ((m <Tendon>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Tendon>)))
  ...
  "40cb16776c2b7ebadec4e4fb33291d31")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Tendon)))
  "Returns md5sum for a message object of type 'Tendon"
  "40cb16776c2b7ebadec4e4fb33291d31")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Tendon>)))
  ...
  (cl:format cl:nil "Header header~%# muscle names~%string[] name~%# force in Newton~%float32[] force~%# length in meter~%float32[] l~%# velocity in meter/s~%float32[] ld~%# number of viapoints~%int32[] number_of_viapoints~%# viapoints of the tendon in global coordinates~%geometry_msgs/Vector3[] viapoints~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Tendon)))
  "Returns full string definition for message of type 'Tendon"
  (cl:format cl:nil "Header header~%# muscle names~%string[] name~%# force in Newton~%float32[] force~%# length in meter~%float32[] l~%# velocity in meter/s~%float32[] ld~%# number of viapoints~%int32[] number_of_viapoints~%# viapoints of the tendon in global coordinates~%geometry_msgs/Vector3[] viapoints~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
