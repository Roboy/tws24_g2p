...
(defsystem "roboy_simulation_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "BodyInformation" :depends-on ("_package_BodyInformation"))
    (:file "_package_BodyInformation" :depends-on ("_package"))
    ...
    (:file "LinkInformation" :depends-on ("_package_LinkInformation"))
    (:file "_package_LinkInformation" :depends-on ("_package"))
