...
"""autogenerated by genpy from roboy_middleware_msgs/SystemStatus.msg. Do not edit."""
import codecs
import sys
...
class SystemStatus(genpy.Message):
  _md5sum = "a154f05d39fafbb9bb8a98f0b5bb4351"
  _type = "roboy_middleware_msgs/SystemStatus"
...
uint8 status
"""
  __slots__ = ['header','body_parts']
  _slot_types = ['std_msgs/Header','roboy_middleware_msgs/BodyPart[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = roboy_middleware_msgs.msg.BodyPart()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
