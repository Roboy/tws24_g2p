...
"""autogenerated by genpy from roboy_middleware_msgs/BodyPart.msg. Do not edit."""
import codecs
import sys
...
class BodyPart(genpy.Message):
  _md5sum = "7244bd0a66f4dc551fcf27198addf4f4"
  _type = "roboy_middleware_msgs/BodyPart"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Sample values
uint8 ENABLED=0
uint8 DISABLED=1
